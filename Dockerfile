# ComfyUI_Ultime — CUDA 12.8 (Torch & HF installés au runtime)
...
# ENV par défaut (aucun secret ici)
ENV ENABLE_JUPYTER=true \
    ...
    TORCH_SPEC_TORCH=torch \
    TORCH_SPEC_VISION=torchvision \
    TORCH_SPEC_AUDIO=torchaudio
